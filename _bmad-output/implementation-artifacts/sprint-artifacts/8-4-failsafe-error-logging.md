...
1. **Given** primary audit_log unavailable
2. **When** error or action occurs
3. **Then** system falls back to CloudWatch Logs
4. **And** fallback triggers alerts
...
- Existing signals: Implemented via auditService fallback
