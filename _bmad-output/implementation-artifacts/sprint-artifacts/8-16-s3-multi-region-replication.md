...
1. **Given** S3 CRR configured
2. **When** document uploaded to us-east-1
3. **Then** automatically replicates to us-west-2
...
- Existing signals: Infrastructure - AWS config (operational)
