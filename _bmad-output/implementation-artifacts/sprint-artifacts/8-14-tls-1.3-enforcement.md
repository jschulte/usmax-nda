...
1. **Given** user accesses application
2. **When** connection established
3. **Then** TLS 1.3 used, HTTPS enforced, Security headers set
...
- Existing signals: Infrastructure - load balancer config (operational)
