...
1. **Given** user uploads file
2. **When** processed
3. **Then** validates: File type (RTF/PDF/DOCX), Max size (10MB), Basic malware scanning
...
- Existing signals: Implemented in fileUpload middleware
