...
1. **Given** user creating/editing NDA
2. **When** they attempt to save
3. **Then** system validates: Required fields not empty, Client-side and server-side validation
4. **And** submission blocked until valid
...
- Existing signals: Implemented in service layer
