...
1. **Given** PostgreSQL on Lightsail
2. **When** data written to disk
3. **Then** encrypted using Lightsail volume encryption (AES-256)
...
- Existing signals: AWS RDS encryption (infrastructure)
