...
1. **Given** internet connection lost
2. **When** I attempt operation
3. **Then** "You appear to be offline" banner, Disabled actions, Retry when connection restored
...
- Existing signals: Frontend implementation (out of scope for backend)
