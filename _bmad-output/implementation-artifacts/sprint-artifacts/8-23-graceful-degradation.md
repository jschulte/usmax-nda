...
1. **Given** secondary feature fails
2. **When** I attempt core workflow
3. **Then** core continues to function, Failed feature shows error
...
- Existing signals: Implemented in error handling
