...
1. **Given** snapshot exists
2. **When** I initiate restore
3. **Then** can create new instance from snapshot, RTO <4 hours, RPO <24 hours
...
- Existing signals: Infrastructure - AWS RDS feature (operational)
