...
1. **Given** operation failed
2. **When** I see error
3. **Then** "Retry" button available, Re-executes with same parameters
...
- Existing signals: Frontend retry patterns (out of scope for backend)
