...
1. **Given** user enters data
2. **When** validation runs
3. **Then** system validates: Email addresses (RFC 5322), Phone numbers ((XXX) XXX-XXXX), Dates (mm/dd/yyyy)
4. **And** real-time inline validation
...
- Existing signals: Implemented in routes/services
