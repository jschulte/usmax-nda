...
1. **Given** user entering text
2. **When** typing
3. **Then** shows character count, Prevents typing beyond limit
4. **And** Authorized Purpose: 255 chars limit
...
- Existing signals: Implemented (authorizedPurpose 255 char limit)
