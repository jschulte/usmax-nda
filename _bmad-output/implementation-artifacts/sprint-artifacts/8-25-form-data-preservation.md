...
3. **Then** data preserved via: Auto-save to database (if online), Temporary save to sessionStorage (if offline)
...
- Existing signals: Implemented in draft auto-save (Story 3.6)
