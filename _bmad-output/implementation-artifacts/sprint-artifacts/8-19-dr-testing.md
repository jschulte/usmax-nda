...
1. **Given** DR procedures documented
2. **When** quarterly test
3. **Then** restore snapshot, verify integrity, measure RTO/RPO
...
- Existing signals: Infrastructure - operational procedure (out of scope)
