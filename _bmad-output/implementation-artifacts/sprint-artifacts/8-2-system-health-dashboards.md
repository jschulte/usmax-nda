...
2. **When** I access "System Health" dashboard
3. **Then** I see: Uptime %, Error rate, API response times, Database performance, Active users, Resource usage
4. **And** metrics update near real-time
...
- Existing signals: Infrastructure - AWS CloudWatch (operational)
