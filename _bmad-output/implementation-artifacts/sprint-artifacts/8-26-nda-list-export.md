...
1. **Given** viewing NDA list with filters
2. **When** I click "Export"
3. **Then** generates CSV/Excel with all columns, filtered results
...
- Existing signals: Implemented - GET /api/ndas/export endpoint
