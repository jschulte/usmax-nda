...
1. **Given** user requests download
2. **When** link generated
3. **Then** pre-signed S3 URL (15-min expiry), Logs download BEFORE generating URL
...
- Existing signals: Implemented in s3Service/documentService
