...
1. **Given** customer has old emails
2. **When** forwarded to SES address or uploaded as EML files
3. **Then** system parses and imports NDAs
...
- Existing signals: Phase 2 scope - deferred (documented as out of scope)
