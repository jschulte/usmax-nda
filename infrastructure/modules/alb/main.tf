...
resource "aws_route53_record" "cert_validation" {
  for_each = var.domain_name != null && var.certificate_arn == null && var.route53_zone_id != null ? {
...
resource "aws_acm_certificate_validation" "main" {
  count = var.domain_name != null && var.certificate_arn == null && var.route53_zone_id != null ? 1 : 0
