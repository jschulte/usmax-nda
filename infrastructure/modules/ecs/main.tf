  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        ...
        },
        {
          ...
          valueFrom = "${var.app_secrets_arn}:COGNITO_USER_POOL_ID::"
        },
        {
          name      = "COGNITO_APP_CLIENT_ID"
          valueFrom = "${var.app_secrets_arn}:COGNITO_APP_CLIENT_ID::"
        },
        {
          name      = "SES_FROM_EMAIL"
          valueFrom = "${var.app_secrets_arn}:SES_FROM_EMAIL::"
        }
      ]
...
resource "aws_ecs_service" "main" {
  ...
  launch_type = null # Use capacity provider instead
