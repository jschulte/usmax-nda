...
- [ ] **Task 1: Agency Group Grant Service** (AC: 1, 2, 3)
...
- [ ] **Task 3: Agency Group Access API** (AC: All)
...
- [ ] **Task 4: Cache Invalidation** (AC: 1, 3)
...
- [ ] **Task 5: Frontend - Access Management UI** (AC: 1, 2)
...
- [ ] **Task 6: Frontend - User Autocomplete Component** (AC: 1)
...
- [ ] **Task 7: Frontend - Revoke Access Action** (AC: 3)
